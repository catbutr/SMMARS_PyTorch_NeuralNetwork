...
import Networks.RecurrentNN as rnn
from Blocks.NeuralNetworkBlock import NeuralNetworkBlock as NNB

#Моноблок
class RecurrentBlock(NNB):
    def __init__(self,inputSize=1, hiddenSize=1, outputSize=1, numberOfLayers=1,criterion=nn.MSELoss()):
        super().__init__(criterion)
        self.model = rnn.ReccurentNN(inputSize==inputSize, hiddenSize==hiddenSize, outputSize=outputSize ,numberOfLayers=numberOfLayers, activationFunction=1)
