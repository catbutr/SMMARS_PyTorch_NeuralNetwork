...
lstm_r2 = r2s(dataY_plot[cutoff_point:180, :],dataY_lstm[cutoff_point:180, :])
rnn_r2 = r2s(dataY_plot[cutoff_point:180, :],dataY_rnn[cutoff_point:180, :])
gru_r2 = r2s(dataY_plot[cutoff_point:180, :],dataY_gru[cutoff_point:180, :])
